(module
  ...
  (data (i32.const 1024) "Box0 = %d, Box = %d, ratio = %.4f\0A\00A/R %d/%d\0A\00X\00+\00.\00\0A\00Asked for %d cells, over the limit %d\0A\00")
  ...
  (func $read_region (export "read_region") (param $x0 i32) (param $y0 i32) (param $sX i32) (param $sY i32) (result i32)
    ...
    (if (i32.gt_s (i32.mul (get_local $sX) (get_local $sY)) (i32.const 10000))
      (then
        ...
        (global.set $@stack (get_local $@stack_entry))
        (return (i32.const 0))))
    (set_local $target (i32.const 1117))
  ...
  (func $malloc (param $size i32) (result i32)
    ...
    (if (if (result i32) (i32.ge_s (global.get $__mm_first) (i32.const 0)) (then (i32.const 0)) (else (i32.ne (i32.eq (global.get $__mm_inuse) (global.get $__mm_capacity)) (i32.const 0))))
      (then
        (set_local $required (i32.add (i32.div_s (i32.add (i32.add (i32.const 1117) (global.get $__mm_extra_offset)) (i32.mul (i32.mul (i32.add (global.get $__mm_capacity) (global.get $__mm_expand_by)) (i32.const 8)) (get_local $unit_size))) (i32.const 64000)) (i32.const 1)))
